import 'package:admin_layout_editor/src/layout_model/custom_margin.dart';
...
class StyleElement extends LayoutStyle {
  StyleElement(name) : super("styleElement", name) {
    ...
    properties['border'] = Property('граница',
    ...
    properties['margin'] = Property('Внешний отступ', [0, 0, 0, 0], type: CustomMargin);
  }
}
