    ...
    return SizedBox(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            _createIncrementDicrementButton(Icons.remove,
                () => readOnly ? null : _decrementCounter(), fontSizeButton),
            SizedBox(
            ...
            _createIncrementDicrementButton(Icons.add,
                () => readOnly ? null : _incrementCounter(), fontSizeButton),
          ],
        ),
      ),
    );
